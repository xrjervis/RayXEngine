...
void TheApp::LoadDefaultAssets() {
	...
	g_theResourceManager->LoadTexture2D("wolf_diffuse", "Data/Images/T_Wolf_Black.png");
	...
	g_theResourceManager->LoadMaterial("wolf", "Data/Materials/wolf.mat");
	g_theResourceManager->LoadSkeletalMesh("wolf", "Data/Models/SK_Wolf.FBX");
}
